    ...
    <div className="space-y-6">
      ...
      <section className="grid gap-4 sm:grid-cols-2 xl:grid-cols-5">
        {statCards.map((stat) => (
          <Card
            key={stat.title}
            className="border-border/70 bg-card/75 overflow-hidden"
          >
      ...
      <section className="grid gap-4 lg:grid-cols-2">
        <Card className="border-border/70 bg-card/75 h-fit self-start">
          <CardHeader>
        ...
        <Card className="border-border/70 bg-card/75">
          ...
          <CardContent className="space-y-3">
            <div className="bg-muted/55 flex items-start gap-3 rounded-lg border p-3">
