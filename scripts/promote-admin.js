...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var _a, email, roleArg, role, user;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = process.argv, email = _a[2], roleArg = _a[3];
                    if (!email) {
                        console.error("Usage: npx tsx scripts/promote-admin.ts <email> [admin|super_admin]");
                        process.exit(1);
                    }
                    role = roleArg === "admin" ? "admin" : "super_admin";
                ...
                case 1:
                    ...
                    if (user.role === role) {
                        console.log("User ".concat(email, " is already a ").concat(role));
                        process.exit(0);
                    }
                ...
                case 2:
                    _b.sent();
                    console.log("\u2713 Promoted ".concat(email, " to ").concat(role));
                    return [2 /*return*/];
            }
        });
    });
