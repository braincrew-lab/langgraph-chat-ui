"""Authentication handler for NextAuth.js JWT tokens (GitHub OAuth mode).

This module validates JWT tokens issued by NextAuth.js when using GitHub OAuth.
The token validation is the same regardless of the OAuth provider.
...
async def get_current_user(
    ...
    The JWT token contains user info from GitHub, normalized by NextAuth.js.
    """
